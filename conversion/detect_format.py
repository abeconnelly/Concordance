    ...
    for line in f_in:
        ...
        if re.match('#', line):
            if re.match(r'#TYPE.*VAR-ANNOTATION', line):
                if VERBOSE: print "Complete Genomics var file format (CGIVAR) detected"
            ...
            if re.match(r'# This data file generated by 23andMe', line):
                if VERBOSE: print "23andme microarray genotyping data (23ANDME) detected"
        ...
        if ( len(csv_data) > 5 and
            ...
            if VERBOSE: print "deCODEme microarray genotyping data (deCODEme) guessed"
            looks_like['deCODEme'] = True
        ...
        if ( len(tsv_data) > 6 and
            ...
            if VERBOSE: print "Complete Genomics var file format (CGIvar) guessed"
            looks_like['CGIVAR'] = True
        if ( len(tsv_data) > 6 and
